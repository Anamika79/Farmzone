<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BuyerDeliveryDue.aspx.vb" Inherits="FarmZone.BuyerDeliveryDue" %>
...
<head runat="server">
 <meta charset="utf-8"/>
    ...
    <title>Farm Zone Delivery Dues</title>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="Home.aspx">
...
<%--End of Modal for PDF--%>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            buyerloadpendinginvoicestodelivery();
